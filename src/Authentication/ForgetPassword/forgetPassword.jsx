...
import { fogetPassword } from "../../Store/ResetPassword/ForgetPasswordSlice";
...
export default function ForgetPassword() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      dispatch(fogetPassword(formData)).then((response) => {
        if (response.payload === "Success") {
          ...
          toast.error(
            "Email has not been found in our record. Please add valid email!"
          );
        }
      });
    } catch (err) {
