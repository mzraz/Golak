...
import UsersReport from "../Views/Reports/AllUsersReport/usersReport";
import InactiveUsersReport from "../Views/Reports/InactiveUsers/inactiveUsers";
import CirclesReport from "../Views/Reports/AllCirclesReport/circlesReport";
import InactiveCirclesReport from "../Views/Reports/InactiveCirclesReport/inactiveCirclesReport";
          ...
          <>
            {SUPERADMIN === role_id && (
              <>
                ...
                />
                <Route
                  path="/reports/inactive-users-report"
                  element={
                    <ProtectedRoute token={token} redirectPath={"/login"}>
                      <InactiveUsersReport />
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/reports/inactive-circles-report"
                  element={
                    <ProtectedRoute token={token} redirectPath={"/login"}>
                      <InactiveCirclesReport />
                    </ProtectedRoute>
                  }
                />
                <Route
                ...
                <Route
                  path="/reports"
                  element={
                    <ProtectedRoute token={token} redirectPath={"/reports"}>
                      <Reports />
                    </ProtectedRoute>
                  }
                />
